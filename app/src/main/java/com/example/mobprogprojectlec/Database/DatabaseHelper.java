...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(album);
        String song = "CREATE TABLE IF NOT EXISTS Song(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title varchar(100), artist_id int, album_id int, genre varchar(100), preview varchar(255), spotify varchar(100), FOREIGN KEY(artist_id) REFERENCES Artist(id), FOREIGN KEY(album_id) REFERENCES Album(id))";
        db.execSQL(song);
        ...
        db.execSQL(user);
        String review = "CREATE TABLE IF NOT EXISTS Review(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, comment varchar(255), user_id int, song_id int, rating int, timestamp long, FOREIGN KEY(user_id) REFERENCES User(id), FOREIGN KEY(song_id) REFERENCES Song(id))";
        db.execSQL(review);
    }
